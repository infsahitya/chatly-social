    ...
    if ((t && typeof t == "object") || typeof t == "function")
      for (let i of Jl(t))
        !Wl.call(e, i) &&
          ...
          sn(e, i, {
            get: () => t[i],
            enumerable: !(n = Ql(t, i)) || n.enumerable,
          });
    return e;
  };
var ve = (e, t, r) => (
...
var ws = X((Vt) => {
  ...
  function rc(e) {
    ...
    if (e.length !== void 0)
      return typeof e.length != "number" || Si(e.length) ? et(0) : vi(e);
  ...
  function pc(e) {
    ...
    let r = "",
      n = 0;
    for (; n < t; )
      r += String.fromCharCode.apply(String, e.slice(n, (n += ns)));
    return r;
  }
  function fc(e, t, r) {
    let n = "";
  ...
  T.prototype.readFloatLE = function (e, t) {
    return (
      (e = e >>> 0), t || ae(e, 4, this.length), $t.read(this, e, !0, 23, 4)
    );
  };
  T.prototype.readFloatBE = function (e, t) {
    return (
      (e = e >>> 0), t || ae(e, 4, this.length), $t.read(this, e, !1, 23, 4)
    );
  };
  T.prototype.readDoubleLE = function (e, t) {
    return (
      (e = e >>> 0), t || ae(e, 8, this.length), $t.read(this, e, !0, 52, 8)
    );
  };
  T.prototype.readDoubleBE = function (e, t) {
    return (
      (e = e >>> 0), t || ae(e, 8, this.length), $t.read(this, e, !1, 52, 8)
    );
  };
  ...
  function yc(e, t, r) {
    qt(t, "offset"),
      (e[t] === void 0 || e[t + r] === void 0) && br(t, e.length - (r + 1));
  }
  ...
  function bc(e) {
    if (((e = e.split("=")[0]), (e = e.trim().replace(hc, "")), e.length < 2))
      return "";
...
var $i = X((q) => {
        ...
        for (var vt = 1, Xe = !0; vt < k.length; vt += 1) {
          ...
          if (
            ...
            if (a && vt + 1 >= k.length) {
              var Bt = a(ne, Pe);
              (Xe = !!Bt),
                Xe && "get" in Bt && !("originalValue" in Bt.get)
                  ? (ne = Bt.get)
                  : (ne = ne[Pe]);
  ...
  function Nc(e, t) {
    var r = ct.styles[t];
    return r
      ? "\x1B[" + ct.colors[r][0] + "m" + e + "\x1B[" + ct.colors[r][1] + "m"
      : e;
  }
  function Lc(e, t) {
    return e;
...
var Hs = X((ge, Pn) => {
  ...
  function fp() {
    return "colors" in ge.inspectOpts
      ? !!ge.inspectOpts.colors
      : pp.isatty(h.stderr.fd);
  }
  function dp(e) {
  ...
  var Yt = {
    ...
    relative: function (e, t) {
      if (
        (Ke(e),
        Ke(t),
        e === t || ((e = Yt.resolve(e)), (t = Yt.resolve(t)), e === t))
      )
        return "";
...
var ma = X((u0, Xi) => {
  ...
  function vr() {}
  Object.create &&
    ((vr.prototype = Object.create(null)), new vr().__proto__ || (Te = !1));
  function Mp(e, t, r) {
...
var Ep = {
  enabled:
    !ta && ra == null && na !== "dumb" && ((Wi != null && Wi !== "0") || ia),
};
function H(e, t) {
...
function Dp(e) {
  return {
    datamodel: { models: oo(e.models), enums: oo(e.enums), types: oo(e.types) },
  };
}
function oo(e) {
...
C.precision = C.sd = function (e) {
  ...
  return (
    r.d ? ((t = ja(r.d)), e && r.e + 1 > t && (t = r.e + 1)) : (t = NaN), t
  );
};
C.round = function () {
  var e = this,
...
function vf(e) {
  var t,
    ...
    a = [];
  if (
    (e === void 0 ? (e = this.precision) : Me(e, 1, bt),
    (n = Math.ceil(e / D)),
    this.crypto)
  )
...
var nu = (e) => (Array.isArray(e) ? e : e.split(".")),
  ...
  iu = (e, t, r) =>
    nu(t).reduceRight(
      (n, i, o, s) => Object.assign({}, Po(e, s.slice(0, o)), { [i]: n }),
      r,
    );
function ed(e, t) {
...
var nd = (e) => e,
  ...
  B = {
    ...
    util: {
      ...
      objId: function (e) {
        return (
          e.__id || Object.defineProperty(e, "__id", { value: ++id }), e.__id
        );
      },
...
function gu({
  ...
  return n.isEmpty() || e == null || typeof e != "object" || !i.models[t]
    ...
    : Xn({
        ...
        runtimeDataModel: i,
        visitor: (s, a, u) =>
          du({ result: s, modelName: Ye(a), select: u.select, extensions: n }),
      });
}
m();
p();
...
function Tu(e, t, r) {
  ...
  return !t.result || !(t.result.$allModels || t.result[n])
    ...
    : Td({
        ...e,
        ...vu(t.name, e, t.result.$allModels),
        ...vu(t.name, e, t.result[n]),
      });
}
function Td(e) {
  let t = new Je(),
...
function ai() {
  return (
    (oi === null || oi.byteLength === 0) &&
      (oi = new Uint8Array(I.memory.buffer)),
    oi
  );
}
function gr(e, t) {
...
function De() {
  return (
    (si === null || si.byteLength === 0) &&
      (si = new Int32Array(I.memory.buffer)),
    si
  );
}
function Kd(e, t, r, n) {
      ...
      try {
        ...
        if (l.errors)
          throw l.errors.length === 1
            ...
            : new ce(JSON.stringify(l.errors), {
                clientVersion: this.config.clientVersion,
              });
    ...
    async requestBatch(r, { transaction: n, traceparent: i }) {
      ...
      if (a.errors)
        throw a.errors.length === 1
          ...
          : new ce(JSON.stringify(a.errors), {
              clientVersion: this.config.clientVersion,
            });
  ...
  for (let n of e) {
    ...
    o
      ? t.set(i, {
          ...
          argument: {
            ...n.argument,
            typeNames: Mm(o.argument.typeNames, n.argument.typeNames),
          },
        })
      : t.set(i, n);
  }
...
function Dm(e, t) {
  ...
  n instanceof pe &&
    ((i = n.getField(r)) == null || i.markAsError(), Vm(n, e.arguments)),
    t.addErrorMessage((o) =>
      Xu(
        o,
        r,
...
function Hm(e, t, r) {
  for (let [n, i] of Object.entries(t)) {
    ...
    o &&
      ...
      i === !0
        ? (e[n] = !0)
        : typeof i == "object" && (e[n] = $o(i, r.nestSelection(n)));
  }
}
function zm(e, t) {
  let r = {},
  ...
  for (let [o, s] of Object.entries(i)) {
    ...
    (n != null && n[o] && !a) ||
      (s === !0
        ? (r[o] = !0)
        : typeof s == "object" && (r[o] = $o(s, t.nestSelection(o))));
  }
  return r;
}
function il(e, t) {
    ...
    (n) => {
      ...
      if (Array.isArray(n)) {
        ...
        switch (t) {
          ...
          case "mysql": {
            (i = n.sql),
              (o = { values: nn(n.values), __prismaRawParameters__: !0 });
            break;
          }
          case "cockroachdb":
          case "postgresql":
